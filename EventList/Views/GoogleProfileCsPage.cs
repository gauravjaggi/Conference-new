...
namespace EventList.Views
{
    public class GoogleProfileCsPage : ContentPage
    {
        ...
        public GoogleProfileCsPage()
        {
            ...
            var webView = new Helpers.CustWebViewRenderer
            {
                Source = authRequest,
                HeightRequest = 1
            };
        ...
        private async void WebViewOnNavigated(object sender, WebNavigatedEventArgs e)
        {
            ...
            if (code != "" && Count==1)
            {
                ...
                {
                    UserId = _googleViewModel.GoogleProfile.Id,
                    Email = "abc@gmail.com",
                    GivenName = _googleViewModel.GoogleProfile.Name.GivenName,
                    FamilyName = _googleViewModel.GoogleProfile.Name.FamilyName
                };

                if (!App._Realm.All<GoogleUser>().ToList().Any(x => x.UserId.Equals(googleUser.UserId)))
                {
                    App._Realm.Write(() =>
                    {
