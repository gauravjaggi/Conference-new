...
namespace EventList.Views
{
    public class FacebookProfileCsPage : ContentPage
    {
        ...
        /// </summary>
        private string ClientId = "583360415389054";//"1570192756563503";
        ...
        private async void WebViewOnNavigated(object sender, WebNavigatedEventArgs e)
        {
            ...
            if (accessToken != "")
            {
                ...
                {
                    UserId = vm.FacebookProfile.Id,
                    Email = "abc@gmail.com",
                    GivenName = vm.FacebookProfile.FirstName,
                    FamilyName = vm.FacebookProfile.LastName
                };
