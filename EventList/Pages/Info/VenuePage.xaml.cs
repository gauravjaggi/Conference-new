...
namespace EventList.Pages.Info
{
    ...
    {
        VenueViewModel vm;
        public VenuePage(Venue venue)
        {
            InitializeComponent(); BindingContext = vm = new VenueViewModel();

            vm.Latitude =Convert.ToDouble(venue.Latitude);
            vm.Longitude = Convert.ToDouble(venue.Longitude);
