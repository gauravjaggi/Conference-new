    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                assembliesToInclude.Add(typeof(EventList.Interfaces.ICategoryStore).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(EventList.Store.CategoryStore).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(EventList.Services.FavoriteService).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(ZXing.BarcodeReader).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(EventList.Pages.Home.FeedPage).GetTypeInfo().Assembly);                
